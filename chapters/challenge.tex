...
\begin{table}[]
    ...
    \textsf{Symptoms of Mental Health Issues} & 18 \\ %%% PTSD, Psychosis, Eating Disoders, Depression, etc %%%
  ...
  \begin{table}[]
    ...
    \textsf{Childhood History}  \\ %%% like how and where they grew up %%%
    \textsf{Interpersonal Concerns} \\ %%% recent death in the family, etc %%%
    \textsf{Education}  \\
